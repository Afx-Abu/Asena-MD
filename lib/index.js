...
module.exports = {
  ...
  Module: Asena,
  Function: Asena,
  isPublic: config.MODE.toLowerCase() === "public",
  ...
  AddMp3Meta: async (
    songbuffer,
    coverBuffer,
    options = { title: "WhatsAsena Whatsapp bot", artist: ["Asena"] }
  ) => {
    ...
    writer
      ...
      .setFrame("TPE1", ["WhatsAsena"])
      .setFrame("APIC", {
        type: 3,
        data: coverBuffer,
        description: "Asena Public Bot",
      });
    writer.addTag();
